...
public class CalibrationGermany implements ModelComponent {
    ...
    public void calibrateModel(boolean dc, boolean mc, DataSet dataSet) {
        ...
        Map<DcModelNameGermany, Map<Purpose, Double>> calibrationMatrixDc = new HashMap<>();
        ...
        for (int iteration = 0; iteration < maxIter; iteration++) {
            ...
            dcModel.updatedomDcCalibrationV(calibrationMatrixDc.get(DcModelNameGermany.domesticDc));
            dcOutboundModel.updateIntOutboundCalibrationV(calibrationMatrixDc.get(DcModelNameGermany.internationalOutboundDc));
            dcInBoundModel.updateIntInboundCalibrationV(calibrationMatrixDc.get(DcModelNameGermany.internationalInboundDc));
    ...
    public Map<DcModelNameGermany, Map<Purpose, Double>> getAverageTripDistances(ArrayList<LongDistanceTrip> allTrips) {

        Map<DcModelNameGermany, Map<Purpose, Double>> averageDistances = new HashMap<>();
        Map<DcModelNameGermany, Map<Purpose, Double>> counts = new HashMap<>();

        for (DcModelNameGermany name : DcModelNameGermany.values()) {
            ...
            if (t.getOrigZone().getZoneType().equals(ZoneTypeOntario.ONTARIO) || t.getDestZoneType().equals(ZoneTypeOntario.ONTARIO)) {
                ...
                if (!t.isInternational()) {
                    ...
                    if (t.getTravelDistanceLevel2() < 2000) {
                        DcModelNameGermany name = DcModelNameGermany.domesticDc;
                    ...
                    if (t.getTravelDistanceLevel2() < 4000) {
                        DcModelNameGermany name = DcModelNameGermany.internationalOutboundDc;
                        addTripToAverageCalculator(averageDistances, counts, t, name);
                    }
                    ...
                    if (t.getTravelDistanceLevel2() < 4000) {
                        DcModelNameGermany name = DcModelNameGermany.internationalInboundDc;
                        addTripToAverageCalculator(averageDistances, counts, t, name);
                    }
                }
            }
    ...
    private void addTripToAverageCalculator(Map<DcModelNameGermany, Map<Purpose, Double>> averageDistances, Map<DcModelNameGermany, Map<Purpose, Double>> counts, LongDistanceTrip tripToCast, DcModelNameGermany name) {
        LongDistanceTripOntario t = (LongDistanceTripOntario) tripToCast;
    ...
    public Map<DcModelNameGermany, Map<Purpose, Double>> calculateCalibrationMatrix(ArrayList<LongDistanceTrip> allTrips) {

        Map<DcModelNameGermany, Map<Purpose, Double>> averageDistances = getAverageTripDistances(allTrips);
        Map<DcModelNameGermany, Map<Purpose, Double>> calibrationMatrix = new HashMap<>();

        double expansionFactor = 1;

        //hard coded for calibration
        calibrationMatrix.putIfAbsent(DcModelNameGermany.domesticDc, new HashMap<>());
        calibrationMatrix.get(DcModelNameGermany.domesticDc).put(PurposeOntario.VISIT, (averageDistances.get(DcModelNameGermany.domesticDc).get(PurposeOntario.VISIT) / 133 - 1) * expansionFactor + 1); //domestic visit
        calibrationMatrix.get(DcModelNameGermany.domesticDc).put(PurposeOntario.BUSINESS, (averageDistances.get(DcModelNameGermany.domesticDc).get(PurposeOntario.BUSINESS) / 175 - 1) * expansionFactor + 1);//domestic business
        calibrationMatrix.get(DcModelNameGermany.domesticDc).put(PurposeOntario.LEISURE, (averageDistances.get(DcModelNameGermany.domesticDc).get(PurposeOntario.LEISURE) / 134 - 1) * expansionFactor + 1);//domestic leisure

        calibrationMatrix.putIfAbsent(DcModelNameGermany.internationalOutboundDc, new HashMap<>());
        calibrationMatrix.get(DcModelNameGermany.internationalOutboundDc).put(PurposeOntario.VISIT, (averageDistances.get(DcModelNameGermany.internationalOutboundDc).get(PurposeOntario.VISIT) / 642 - 1) * expansionFactor + 1); //to us visit
        calibrationMatrix.get(DcModelNameGermany.internationalOutboundDc).put(PurposeOntario.BUSINESS, (averageDistances.get(DcModelNameGermany.internationalOutboundDc).get(PurposeOntario.BUSINESS) / 579 - 1) * expansionFactor + 1);//to us business
        calibrationMatrix.get(DcModelNameGermany.internationalOutboundDc).put(PurposeOntario.LEISURE, (averageDistances.get(DcModelNameGermany.internationalOutboundDc).get(PurposeOntario.LEISURE) / 515 - 1) * expansionFactor + 1);//to us leisure

        calibrationMatrix.putIfAbsent(DcModelNameGermany.internationalInboundDc, new HashMap<>());
        calibrationMatrix.get(DcModelNameGermany.internationalInboundDc).put(PurposeOntario.VISIT, (averageDistances.get(DcModelNameGermany.internationalInboundDc).get(PurposeOntario.VISIT) / 697 - 1) * expansionFactor + 1); //from us visit
        calibrationMatrix.get(DcModelNameGermany.internationalInboundDc).put(PurposeOntario.BUSINESS, (averageDistances.get(DcModelNameGermany.internationalInboundDc).get(PurposeOntario.BUSINESS) / 899 - 1) * expansionFactor + 1);//from us business
        calibrationMatrix.get(DcModelNameGermany.internationalInboundDc).put(PurposeOntario.LEISURE, (averageDistances.get(DcModelNameGermany.internationalInboundDc).get(PurposeOntario.LEISURE) / 516 - 1) * expansionFactor + 1);//from us leisure
    ...
    public void printOutCalibrationResults(DomesticDestinationChoice domDc, IntOutboundDestinationChoice intOutDc, IntInboundDestinationChoice intInDc,
        ...
        for (Purpose purpose : PurposeOntario.values()) {
            ...
            logger.info(DcModelNameGermany.domesticDc + "\t" + purpose + "\t" + map.get(purpose));
        }
        map = intOutDc.getCalibrationV();
        for (Purpose purpose : PurposeOntario.values()) {
            logger.info(DcModelNameGermany.internationalOutboundDc + "\t" + purpose + "\t" + map.get(purpose));
        }
        map = intInDc.getCalibrationV();
        for (Purpose purpose : PurposeOntario.values()) {
            logger.info(DcModelNameGermany.internationalInboundDc + "\t" + purpose + "\t" + map.get(purpose));
        }
