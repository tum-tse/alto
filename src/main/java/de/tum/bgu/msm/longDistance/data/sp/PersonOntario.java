...
public class PersonOntario implements Person {
...
// columns 1 to 3: visit, business, leisure
    ...
    public PersonOntario(int id, int hhId, int age, char gender, int occupation, int education, int workStatus, HouseholdOntario hh) {
        this.id = id;
        this.age = age;
        this.gender = gender;
    ...
    public int getAdultsHh() {
        int adultsHh = 0;
        for (PersonOntario p : hh.getPersonsOfThisHousehold()) {
            if (p.getAge() >= 18) {
                adultsHh++;
            }
        }
    ...
    public HouseholdOntario getHousehold() {return hh;}
