 ...
 */
public class ZoneOntario implements Zone {
    private int id;
    private int population = 0;
    private int employment = 0;
    private int households = 0;
    private ZoneTypeOntario zoneType;
    private double accessibility;
    private int combinedZoneId;
    private long staticAttraction;


    public ZoneOntario(int id, int population, int employment, ZoneTypeOntario zoneType, int combinedZoneId) {
        this.id = id;
    ...
    @Override
    public ZoneTypeOntario getZoneType() {
        return zoneType;
    }
